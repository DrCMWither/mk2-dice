...
3. Create a new KV table and sent both [symptoms]( ./symptoms.json) and [synonyms](./synonyms.json) to this KV table; if you're using automatic build, you can just ignore this step and check it later.
