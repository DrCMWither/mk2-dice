...
3. Create a new KV table and sent both [symptoms]( ./build/kv-data/symptoms.json) and [synonyms](./build/kv-data/synonyms.json) to this KV table; if you're using automatic build, you can just ignore this step and check it later.
